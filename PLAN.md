...
>
> 状态：**工程完成，v0.1.6 已发布**（2026-09-07，见 §13）｜ 历史：v1.2 定位修正（读向拥挤→处理管线）；v1.1 M-1 验证闸门
>
...
1. ✅ v0.1.6 已发布：GitHub tag/release 与 PyPI Trusted Publishing 均完成（2026-09-07）
